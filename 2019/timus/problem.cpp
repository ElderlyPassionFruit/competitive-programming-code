...
struct BigInt {
    ...
    friend BigInt sqrt(const BigInt &a1) {
   	...
   	unsigned long long getLen() {
    	unsigned long long ans = (unsigned long long)a.size() - 1;
    	ans *= BASE_DIGITS;
    	int x = a.back();
    	while (x) {
    		ans++;
...
/*
29920596326534453534435155462281785135584566868528 14935750817597319679898609972754380528072289602775
540 2371
*/